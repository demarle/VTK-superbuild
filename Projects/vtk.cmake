...
if(GENERATE_JAVA_PACKAGE)
  ...
  set(_JAVA_AWT_LIBRARY)
  list(LENGTH JAVA_AWT_LIBRARY _JAVA_AWT_LIBRARY_SIZE)
  if(_JAVA_AWT_LIBRARY_SIZE GREATER 1)
    list(GET JAVA_AWT_LIBRARY 0 _JAVA_AWT_LIBRARY)
    foreach(_IDX RANGE 1 _JAVA_AWT_LIBRARY_SIZE 1)
      list(GET JAVA_AWT_LIBRARY _IDX _CURRENT_LIB)
      set(_JAVA_AWT_LIBRARY "${_JAVA_AWT_LIBRARY}|${_CURRENT_LIB}")
    endforeach()
  else()
    set(_JAVA_AWT_LIBRARY JAVA_AWT_LIBRARY)
  endif()
...
add_external_project(vtk
  ...
  CMAKE_ARGS
    ...
    -DJAVA_AWT_LIBRARY:PATH=${_JAVA_AWT_LIBRARY}
